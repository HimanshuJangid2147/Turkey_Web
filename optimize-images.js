...
class ImageOptimizer {
    constructor() {
        ...
        this.webpDir = `${this.outputDir}/webp`;
        this.jpgDir = `${this.outputDir}/jpg`;
        this.pngDir = `${this.outputDir}/png`;
        this.originalDir = 'public/images/original';
    ...
    showResults() {
        ...
        const originalSize = getDirSize(this.inputDir);
        const optimizedSize = getDirSize(this.webpDir) + getDirSize(this.jpgDir) + getDirSize(this.pngDir);
