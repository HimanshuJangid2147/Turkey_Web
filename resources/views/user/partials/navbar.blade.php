    ...
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold" href="/">
            <div class="d-flex align-items-center">
                <img src="{{ asset('icons/Satguru-new-preloader.gif') }}" alt="Logo" class="brand-icon" height="60"
                    width="100">
                <span class="brand-text ms-2">Travel Turkey</span>
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown me-lg-3">
                    <a class="nav-link nav-link-enhanced fw-semibold d-flex align-items-center dropdown-toggle"
                        href="#" id="toursDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <i class="bi bi-compass-fill me-1"></i>Inbound
                    </a>
                    <div class="dropdown-menu dropdown-scrollable" aria-labelledby="toursDropdown">
                        <div class="dropdown-grid">
                            <h6 class="dropdown-header">Choose Your Inbound Tour</h6>
                            ...
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Istanbul
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Ankara
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Izmir
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Antalya
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Malatya
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Adana
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Trabzon
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Van
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Yalova
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="bi bi-compass me-2"></i>Denizli
                            </a>
                            <div class="dropdown-divider"></div>

                            <a class="dropdown-item text-center" href={{ route('inbound-tour') }}>
                ...
                <li class="nav-item dropdown me-lg-3">
                    <a class="nav-link nav-link-enhanced fw-semibold d-flex align-items-center dropdown-toggle"
                        href="#" id="destinationsDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <i class="bi bi-compass-fill me-1"></i>Outbound
                    </a>
                    <div class="dropdown-menu dropdown-scrollable" aria-labelledby="destinationsDropdown">
                        <div class="dropdown-grid">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-center" href={{ route('outbound-tours') }}>
                                <i class="bi bi-grid-3x3-gap me-2"></i>View All
                            </a>
                        </div>
                    </div>
                ...
                {{-- Best Deals --}}
                <li class="nav-item me-lg-3">
                    <a class="nav-link nav-link-enhanced fw-semibold d-flex align-items-center" href="/best-deals">
                        <i class="bi bi-currency-dollar me-1"></i>Best Deals
                    </a>
                </li>

                {{-- Add Language Selector (English, Turkish, Russian, French) dropdown --}}
                <li class="nav-item dropdown me-lg-3">
                    <a class="nav-link nav-link-enhanced fw-semibold d-flex align-items-center dropdown-toggle"
                        href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <i class="bi bi-globe2 me-1"></i>Language
                    </a>
