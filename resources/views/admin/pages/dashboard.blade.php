...
@push('scripts')
    {{-- This page has custom JS, so we push it to the script stack --}}
...
<div class="row">
            ...
            <div class="d-flex align-items-start row">
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-6">
                        {{-- THIS IMAGE PATH IS NOW CORRECT --}}
                        <img src="{{ asset('admin_assets/assets/img/illustrations/man-with-laptop.png') }}"
                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/unicons/chart-success.png') }}"
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/unicons/wallet-info.png') }}"
    ...
    {{-- And so on... the rest of the content remains the same --}}
</div>
@endsection
